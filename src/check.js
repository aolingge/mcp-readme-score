...
const checks = [
  {
    "id": "install",
    "pattern": "install|npx|uvx|pip|docker|安装",
    "message": "Shows install instructions."
  },
  {
    "id": "configuration",
    "pattern": "mcpServers|command|args|env|配置",
    "message": "Shows client configuration."
  },
  {
    "id": "permissions",
    "pattern": "permission|filesystem|network|read|write|权限|文件|网络",
    "message": "Explains permissions."
  },
  {
    "id": "security",
    "pattern": "security|token|secret|安全|密钥",
    "message": "Mentions security boundary."
  }
]
...
export function formatText(report, title = "MCP README Score") {
...
export function formatMarkdown(report, title = "MCP README Score") {
...
export function formatSarif(report, toolName = "mcp-readme-score") {
  return {
    version: '2.1.0',
