...
function help() {
  console.log(`mcp-readme-score v0.1.1

Usage:
  mcp-readme-score --path FILE
  mcp-readme-score FILE --markdown
  mcp-readme-score FILE --sarif > results.sarif
  mcp-readme-score FILE --annotations
  mcp-readme-score FILE --redact
...
try {
  ...
  console.error(`mcp-readme-score: ${error.message}`)
  process.exit(2)
}
